...
CREATE TABLE `bots` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `bot_id` BIGINT UNSIGNED NULL UNIQUE COMMENT 'Telegram Bot ID',
...
('admin_bank_account', 'BCA - 1234567890 - Admin VesperApp', 'Rekening admin untuk topup'),
('system_name', 'VesperApp', 'Nama sistem'),
('support_email', 'support@VesperApp.com', 'Email support'),
