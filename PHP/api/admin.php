    ...
    switch ($action) {
        ...
        case 'update_setting':
            ...
            DB::table('settings')
                ...
                \VesperApp\AuditLogger::logAdminAction('update_setting', [
                    'setting_key' => $key,
        ...
        case 'add_bot':
            ...
            // Audit log
            \VesperApp\AuditLogger::logAdminAction('add_bot', [
                'bot_id' => $botId,
                'bot_name' => $name,
        ...
        case 'toggle_bot':
            ...
            // Audit log
            \VesperApp\AuditLogger::logAdminAction('toggle_bot_status', [
                'bot_id' => $botId,
                'active' => $active
            ], $userId);
        ...
        case 'approve_payment':
            ...
            Database::transaction(function () use ($input, $userId) {
                if ($input['payment_type'] === 'topup') {
                    ...
                    // Audit log
                    \VesperApp\AuditLogger::logAdminAction('approve_topup', [
                    ...
                    \VesperApp\NotificationManager::notifyTopupApproved((int)$payment->user_id, (int)$payment->amount);
                    ...
                    // Audit log
                    \VesperApp\AuditLogger::logAdminAction('approve_withdrawal', [
        ...
        case 'reject_payment':
            ...
            Database::transaction(function () use ($input, $userId) {
                ...
                if ($input['payment_type'] === 'topup') {
                    ...
                    \VesperApp\AuditLogger::logAdminAction('reject_topup', [
                        'payment_id' => $input['payment_id'],
                        'user_id' => $payment->user_id,
                        'reason' => $reason
                    ], $userId);
                    ...
                    \VesperApp\AuditLogger::logAdminAction('reject_withdrawal', [
                        'withdrawal_id' => $input['payment_id'],
                        'user_id' => $withdrawal->user_id,
                        'reason' => $reason
                    ], $userId);
        ...
        case 'approve_content':
            ...
            \VesperApp\AuditLogger::logAdminAction('approve_content', [
        ...
        case 'reject_content':
            ...
            \VesperApp\AuditLogger::logAdminAction('reject_content', [
                'content_id' => $input['content_id'],
                'creator_id' => $content->user_id,
                'reason' => $reason
            ], $userId);
        ...
        case 'post_content_to_channel':
            ...
            \VesperApp\AuditLogger::logAdminAction('post_content_to_channel', [
                'content_id' => $input['content_id'],
        ...
        case 'verify_creator':
            ...
            \VesperApp\AuditLogger::logAdminAction('verify_creator', [
        ...
        case 'add_admin':
            ...
            // Audit log
            \VesperApp\AuditLogger::logAdminAction('add_admin', [
        ...
        case 'deactivate_admin':
            ...
            // Audit log
            \VesperApp\AuditLogger::logAdminAction('deactivate_admin', [
