...
if ($commitMessage === 'N/A') {
    $commitMessage = trim(shell_exec('cd /home/boxanonm/public_html/botsawer && git log -1 --pretty=%B 2>&1'));
}

// Jalankan perintah git pull
$output = shell_exec('cd /home/boxanonm/public_html/botsawer && git pull 2>&1');
