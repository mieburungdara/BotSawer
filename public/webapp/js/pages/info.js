        ...
        <div class="grid-layout fade-in">
            <div class="card col-full">
                <div style="text-align: center; margin-bottom: 25px;">
                    ...
                    <h2 style="font-family: 'Outfit', sans-serif; font-size: 24px; margin-bottom: 5px;">Tentang ${app.settings.app_name}</h2>
                    <p style="color: var(--hint-color); font-size: 14px;">Versi ${app.settings.app_version} (Beta)</p>
                </div>

                <div style="line-height: 1.6; color: var(--text-color); font-size: 15px;">
                    <p><strong>${app.settings.app_name}</strong> adalah platform monetisasi konten digital yang dirancang khusus untuk para kreator di ekosistem Telegram.</p>
                    ...
                    <div style="margin-top: 30px; text-align: center; font-size: 13px; color: var(--hint-color);">
                        &copy; 2026 ${app.settings.app_name} Team. Seluruh hak cipta dilindungi.
                    </div>
                </div>
            </div>
        </div>
