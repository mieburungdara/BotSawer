...
import { loadContentDetail, confirmContent, cancelQueue, deleteContent, donateContent, generateThumbnail } from './pages/content_detail.js';
...
class App {
    ...
    async generateThumbnail(contentId) {
        return generateThumbnail(this, contentId);
    }
